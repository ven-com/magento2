...
(function (factory) {
    ...
    function _createNamespace(name){
        ...
        }else if(_storage_available){
            if(!window._localStorage.getItem(name)) window._localStorage.setItem(name,'{}');
            if(!window._sessionStorage.getItem(name)) window._sessionStorage.setItem(name,'{}');
        }else{
    ...
    var _storage_available=_testStorage('_localStorage');
    ...
    if($.cookie){
        ...
        if(!storage_available && !_storage_available){
    ...
    if(storage_available) {
        ...
        // _localStorage API
        $.localStorage=$.extend({},storage,{_type:'_localStorage'});
        // _sessionStorage API
        $.sessionStorage=$.extend({},storage,{_type:'_sessionStorage'});
    }else{
        // localStorage API
