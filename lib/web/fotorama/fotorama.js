...
// http://bost.ocks.org/mike/shuffle/
    ...
    function touch($el, options) {
        ...
        function onStart(e) {
            $target = $(e.target);
            tail.checked = targetIsSelectFLAG = targetIsLinkFlag = targetIsCanvas = moved = false;
            ...
            targetIsCanvas = $target.is('canvas, canvas *', el);
            ...
            if (!targetIsCanvas && (!touchFLAG || tail.go)) stopEvent(e);
        }
